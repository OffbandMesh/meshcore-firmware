...
**Bench results so far** (#1185, 2026-09-12):
...
**Deferred by the owner (2026-09-12):** battery readings against a meter become their own thread. #1186 is parked as deferred, and #1173's "battery within 2% of a meter" criterion waits with it.
