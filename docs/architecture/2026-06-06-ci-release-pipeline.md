...
## 12. Plan updates (accepted 2026-06-06; corrected 2026-06-07)
...
- **T5 (#19 / Crosswire-ay3) is the post-merge integration test and stays open.** T5 was already
  the separated, purely-testing task, so nothing needed splitting out. It runs POST-MERGE on the
  merged `firmware-base` + a real `-rc` tag. The epic's implementation commits reference only
