...
// GTS Root R4 (self-signed root) -- verifies LetsMesh (leaf -> WE1 -> R4).
// Pinned as the trust anchor instead of the WE1 intermediate, so a WE1
// rotation needs no firmware change (R4 valid to 2036). #48 Item 2.
static const char kGtsRootR4Pem[] =
R"PEM(-----BEGIN CERTIFICATE-----
